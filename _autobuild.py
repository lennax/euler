...
def menu():
	print "1. developer_build: used for development."
	print "2. install_build: used for building before final installation to the system."
	print "3. grab_dependencies: installs all the required packages for debian based systems (ubuntu maverick/ debian squeeze,lenny) or darwin with macports."
